...
public class MemberController {
  ...
  @PostMapping("/new")
  public String memberForm(@Validated MemberDTO memberDTO, BindingResult bindingResult, Model model) {
  ...
  // 정보 수정 처리하는 POST 매핑
  @PostMapping("/edit")
  public String edit(@Validated MemberDTO memberDTO, BindingResult bindingResult, Model model, @AuthenticationPrincipal UserDetails userDetails) {
